...
export default function About() {
  return (
    <div className="min-h-screen bg-slate-50 px-4 py-12 md:py-20 pt-16 md:pt-24 relative">
      {/* Decorative background elements */}
      <div className="absolute top-1/3 left-1/4 text-indigo-200 opacity-10" aria-hidden="true">
        <Star className="w-16 h-16" />
      </div>
      <div className="absolute bottom-1/4 right-1/4 bg-indigo-100 w-32 h-32 rounded-full opacity-20" aria-hidden="true"></div>
      <div className="absolute top-1/2 right-1/3 bg-purple-100 w-24 h-24 rounded-full opacity-10" aria-hidden="true"></div>
      
      <main className="container mx-auto max-w-5xl relative z-10" id="main-content">
        {/* Header Section with Photo and Intro */}
        <div className="flex flex-col md:flex-row items-center md:items-start gap-8 md:gap-12 mb-16 bg-gradient-to-br from-indigo-50 to-transparent p-8 rounded-2xl border border-indigo-100">
          {/* Profile Photo - Using a placeholder */}
          <div className="relative w-48 h-48 md:w-64 md:h-64 overflow-hidden rounded-full border-4 border-indigo-200 shadow-xl bg-white flex items-center justify-center transition-transform duration-300" aria-hidden="true">
            <div className="text-4xl md:text-5xl font-serif text-indigo-700">NJ</div>
            {/* Decorative elements */}
            <div className="absolute -bottom-2 -right-2 w-16 h-16 bg-purple-200 rounded-full opacity-20"></div>
            <div className="absolute -top-2 -left-2 w-12 h-12 bg-indigo-200 rounded-full opacity-20"></div>
          </div>
          
          {/* Name and Intro */}
          <div className="flex-1 text-center md:text-left">
            <h1 className="text-indigo-900 text-4xl md:text-5xl font-serif mb-4 relative inline-block">
              Nurjahan Jhorna
              <span className="absolute -bottom-2 left-0 w-full h-1 bg-gradient-to-r from-indigo-500 to-transparent rounded-full"></span>
            </h1>
            <h2 className="text-purple-700 text-xl md:text-2xl mb-6 font-light">Web & Information Systems Student</h2>
            ...
            <div className="flex flex-wrap gap-4 justify-center md:justify-start">
              <Link 
                href="/#projects" 
                className="px-6 py-3 bg-indigo-700 text-white rounded-lg hover:bg-indigo-800 transition-all duration-300 shadow-md focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 font-medium"
              >
                View My Work
              </Link>
              <Link 
                href="/" 
                className="px-6 py-3 border-2 border-indigo-600 text-indigo-700 rounded-lg hover:bg-indigo-50 hover:text-indigo-800 transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 font-medium"
              >
                Back to Home
              </Link>
            </div>
        ...
        <div className="mb-16">
          <div className="flex items-center justify-center mb-8">
            ...
            <h2 className="text-3xl md:text-4xl font-serif text-center text-indigo-900" id="about">About Me</h2>
            <div className="h-px w-12 bg-indigo-300 ml-4"></div>
          </div>
          
          <div className="bg-white rounded-xl shadow-md p-8 border-l-4 border-l-indigo-600 hover:shadow-lg transition-shadow duration-300">
            ...
            <div className="mt-6 flex justify-center">
              <span className="inline-block px-4 py-2 bg-indigo-100 text-indigo-700 rounded-full text-sm font-medium">Sage Mindset</span>
            </div>
          </div>
        </div>
        ...
        <div className="mb-16">
          <div className="flex items-center justify-center mb-8">
            <div className="h-px w-12 bg-indigo-300 mr-4"></div>
            <h2 className="text-3xl md:text-4xl font-serif text-center text-indigo-900" id="skills">Knowledge & Tools</h2>
            <div className="h-px w-12 bg-indigo-300 ml-4"></div>
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="bg-white p-6 rounded-xl border border-indigo-100 shadow-sm hover:shadow-md transition-shadow">
                <div className="flex items-center gap-4 mb-6">
                  ...
                  <h3 className="text-xl font-medium text-indigo-800 font-serif">Development</h3>
                </div>
                <ul className="space-y-3 text-slate-700">
                  <li className="flex items-center p-2 hover:bg-indigo-50 rounded-lg transition-colors">
              ...
              <div className="bg-white p-6 rounded-xl border border-purple-100 shadow-sm hover:shadow-md transition-shadow">
                <div className="flex items-center gap-4 mb-6">
                  ...
                  <h3 className="text-xl font-medium text-purple-800 font-serif">Design</h3>
                </div>
                <ul className="space-y-3 text-slate-700">
                  <li className="flex items-center p-2 hover:bg-purple-50 rounded-lg transition-colors">
        ...
        {/* Footer Navigation */}
        <nav className="text-center pt-8 border-t border-indigo-100 mt-16" aria-label="Footer navigation">
